...
fec_data_all_years <- read.csv("FEC_Data_All_Years.csv") %>% 
  rename(date = contribution_receipt_date)

salary_guide_2022 <- read.csv("salary_guide.csv") %>% 
  clean_names() %>% 
  filter(!str_detect(department, 'Shady Grove')) %>% 
  rename(salary = appt_base_annual_salary)

salary_guide_2021 <- read.csv("salaries_2021.csv") %>% 
  clean_names() %>% 
  filter(!str_detect(department, 'Shady Grove')) %>% 
  rename(salary = appt_base_annual_salary)

salary_guide_2020 <- read.csv("salary_data_2020.csv") %>% 
  clean_names() %>% 
  filter(!str_detect(department, 'Shady Grove'))

salary_guide_2019 <- read.csv("salary_data_2019.csv") %>% 
  clean_names() %>% 
  filter(!str_detect(department, 'Shady Grove'))

salary_guide_2018 <- read.csv("salary_data_2018.csv") %>% 
  clean_names() %>% 
  filter(!str_detect(department, 'Shady Grove'))

salary_guide_2017 <- read.csv("salary_data_2017.csv") %>% 
  clean_names() %>% 
  filter(!str_detect(department, 'Shady Grove'))

salary_guide_2016 <- read.csv("salary_data_2016.csv") %>% 
  clean_names() %>% 
  filter(!str_detect(department, 'Shady Grove'))

salary_guide_2015 <- read.csv("salary_data_2015.csv") %>% 
  clean_names() %>% 
  filter(!str_detect(department, 'Shady Grove'))

salary_guide_2014 <- read.csv("salary_data_2014.csv") %>% 
  clean_names() %>% 
  filter(!str_detect(department, 'Shady Grove'))

salary_guide_2013 <- read.csv("salary_data_2013.csv") %>% 
  clean_names() %>% 
  filter(!str_detect(department, 'Shady Grove'))
...
state_2022 <- read.csv("state_2022.csv")
state_2021 <- read.csv("state_2021.csv")
state_2020 <- read.csv("state_2020.csv")
state_2019 <- read.csv("state_2019.csv")
state_2018 <- read.csv("state_2018.csv")
state_2017 <- read.csv("state_2017.csv")
state_2016 <- read.csv("state_2016.csv")
state_2015 <- read.csv("state_2015.csv")
state_2014 <- read.csv("state_2014.csv")
state_2013 <- read.csv("state_2013.csv")
...
```{r}
fec_data_all_years <- fec_data_all_years %>% 
...
fec_data_all_years[c('last_name', 'first_name', 'extra_name')] <- str_split_fixed(fec_data_all_years$contributor_name, ' ', 3)

fec_data_all_years$first_name <- tolower(fec_data_all_years$first_name)

fec_data_all_years$last_name <- tolower(fec_data_all_years$last_name)
...
combined_salary_fec_2021 <- fec_data_all_years %>% 
...
combined_salary_fec_2022 <- fec_data_all_years %>% 
...
combined_salary_fec_2020 <- fec_data_all_years %>% 
...
combined_salary_fec_2019 <- fec_data_all_years %>% 
...
combined_salary_fec_2018 <- fec_data_all_years %>% 
...
combined_salary_fec_2017 <- fec_data_all_years %>% 
...
combined_salary_fec_2016 <- fec_data_all_years %>% 
...
combined_salary_fec_2015 <- fec_data_all_years %>% 
...
combined_salary_fec_2014 <- fec_data_all_years %>% 
...
combined_salary_fec_2013 <- fec_data_all_years %>% 
...
write_xlsx(final_donations_by_month, "final_monthly_data.xlsx")
...
write_xlsx(top_schools_2013_2022, "/fec_data_eric/graph_spreadsheets/top_schools_2013_2022.xlsx")



top_schools <- top_schools
  
top_schools$division <- tolower(top_schools$division)

donations_count_by_school <- top_schools %>% 
  group_by(division) %>% 
  arrange(desc(n))
...
write_xlsx(top_recipients_2021_2022, "/fec_data_eric/graph_spreadsheets/top_recipients_2021_2022.xlsx")
